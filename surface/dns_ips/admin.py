...
class IPRangeAdmin(DefaultFilterMixin, admin.ModelAdmin):
    list_display = [
...
class IPAddress(DefaultFilterMixin, admin.ModelAdmin):
    list_display = (
        'source',
        'active',
        'last_seen',
...
class DNSRecordAdmin(DefaultFilterMixin, ImportMixin, ExportActionMixin, admin.ModelAdmin):
...
class DNSRecordValueAdmin(DefaultFilterMixin, ImportMixin, ExportActionMixin, admin.ModelAdmin):
